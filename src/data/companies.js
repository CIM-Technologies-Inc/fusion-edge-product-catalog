...
import img4 from "../assets/img/boysen.png";

export const companies = [
    // { 
        // id: 1, product_name: 'Abenson', val: 'abenson', src: img1, category: [
        ...
        // ] },
        // { id: 2, product_name: 'Home Depot', val: 'home', src: img2 ,category: [
        //     {id: 0, text: 'All', val: 'all'},
        ...
        // ]},
        // { id: 3, product_name: 'Wilcon', val: 'wilcon', src: img3, category: [
        //     {id: 0, text: 'All', val: 'all'},
        //     {id: 1, text: 'Furniture', val: 'furniture'},
        //     {id: 2, text: 'Flooring', val: 'flooring'},
        ...
        { id: 5, product_name: 'Saigres', val: 'Saigres', src: img3, category: [
            {id: 0, text: 'All', val: 'all'},
            {id: 1, text: 'Furniture', val: 'furniture'},
            {id: 2, text: 'Flooring', val: 'flooring'},
            {id: 3, text: 'Construction', val: 'construction'},
